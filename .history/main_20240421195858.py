...
if __name__ == "__main__":
    ...
    for i in compress_methods:
    test(prompts, labels, args, compress_prompt_0, 0)
    test(prompts, labels, args, compress_prompt_1, 1)
    test(prompts, labels, args, compress_prompt_2, 2)
