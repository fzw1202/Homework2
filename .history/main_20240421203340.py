...
def compress_prompt_4(original_prompt, tokenizer=None):
    ...
    sentences = ["Let's think step by step\n", ]
    words = ["First", "Second", "Third", "Then", "And", "Therefore", "Thus", "Similarly", ",", "$", "to", "was", "is", " "]
...
compress_methods = [compress_prompt_0, compress_prompt_1, compress_prompt_2, compress_prompt_3]
